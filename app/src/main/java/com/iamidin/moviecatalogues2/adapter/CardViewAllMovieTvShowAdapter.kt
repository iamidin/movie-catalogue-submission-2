...
class CardViewAllMovieTvShowAdapter(private val listMovieTvShow: ArrayList<MovieTvShow>) : RecyclerView.Adapter<CardViewAllMovieTvShowAdapter.CardViewViewHolder>() {

    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): CardViewViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.item_cardview_movie_tv_show_all, viewGroup, false)
